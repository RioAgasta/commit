      ...
      child: ListView(
        children: [
          UserAccountsDrawerHeader(
            accountName: const Text('Rio Agasta', style: TextStyle(fontWeight: FontWeight.bold),),
            accountEmail: const Text('rioagasta@gmail.com'),
            ...
            decoration: const BoxDecoration(
              image: DecorationImage(
                fit: BoxFit.cover,
                image: NetworkImage(
                    'https://images.unsplash.com/photo-1666213233530-1891c515baf6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=929&q=80'
                ),
              ),
            ),
          ),
