      ...
      child: ListView(
        children: [
          UserAccountsDrawerHeader(
            accountName: Text('Rio Agasta'),
            accountEmail: Text('rioagasta@gmail.com'),
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                fit: BoxFit.cover,
                image: NetworkImage(
                  'https://images.unsplash.com/photo-1666213233530-1891c515baf6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1858&q=80',
                ),
              ),
            ),
          ),
